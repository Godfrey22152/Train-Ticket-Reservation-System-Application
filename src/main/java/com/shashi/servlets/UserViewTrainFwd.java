		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				pw.println("<div class='tab'><table><tr><th>Train Name</th><th>Train Number</th>"
						+ "<th>From Station</th><th>To Station</th><th>Time</th><th>Seats Available</th><th>Fare (NGN)</th><th>Booking</th></tr>");
				...
				for (TrainBean train : trains) {
					...
					pw.println("" + "<tr> " + "" + "<td><a href='view?trainNo=" + train.getTr_no() + "&fromStn="
							...
							+ "</td>" + "<td>&#8358;" + train.getFare() + "</td>" + "<td><a href='booktrainbyref?trainNo="
